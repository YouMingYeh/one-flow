  ...
  return (
    <section className='space-y-6 pb-6 pt-4 md:pb-12 md:pt-6 lg:py-24'>
      <div className='container flex max-w-[64rem] flex-col items-center gap-4 text-center'>
        ...
        <h3 className='pt-8 text-lg'>Q&A</h3>
        <Accordion className='w-full max-w-xl' collapsible type='single'>
          <AccordionItem value='item-1'>
            <AccordionTrigger>
              The payment was not successful, what should I do?
            </AccordionTrigger>
            <AccordionContent>
              <p>
                If the payment was not successful, it could be due to a variety
                of reasons. If you are using a credit card, ensure that your
                card details are correct. Some banks may require you to enable
                online transactions. Also, some countries may have restrictions
              ...
              <p>
                ...
                . We are happy to help you troubleshoot the issue.
              </p>
            </AccordionContent>
          </AccordionItem>
